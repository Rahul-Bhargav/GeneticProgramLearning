...
class BaseSymbolic(six.with_metaclass(ABCMeta, BaseEstimator)):
    ...
    def __init__(self,
        ...
        self.introspecting_function = introspecting_function
        ...
        if start_time is None:
            ...
            print('%4s %8s %16s %8s %16s %16s %10s' %
                  (gen,
                   ...
                   oob_fitness,
                   remaining_time))
            if self.introspecting_function is not None:
                self.introspecting_function(population)
...
class SymbolicRegressor(BaseSymbolic, RegressorMixin):
    ...
    introspecting_function : function, optional(default = None )
        A function that takes the population of programs as an input. This can be used to inspect the population of every generation.
    ...
    def __init__(self,
        ...
        super(SymbolicRegressor, self).__init__(
            ...
            verbose=verbose,
            random_state=random_state,
            introspecting_function=introspecting_function)
